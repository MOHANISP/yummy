...
function displaySearchInput(){
    ...
    <div class="search-container container position-fixed  p-3 rounded-4 shadow">     
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        <div class="col-md-4 col-lg-3 ">
            <div class="position-relative shadow rounded">
                ...
                <i class="fa-solid fa-house-laptop fa-2x text-white"  data-area="${arr[i].strArea}"></i>
        ...
        <div class="col-md-3">
            <div data-ingredient="${arr[i].strIngredient}" class="position-relative shadow rounded ingredientElement">
                <div class="post p-3" data-ingredient="${arr[i].strIngredient}">
                    <i class="fa-solid fa-drumstick-bite fa-3x text-white" data-ingredient="${arr[i].strIngredient}"></i>
...
function displayMealInfo(meal) {
    ...
    for (let i = 1; i <= 20; i++) {
        if (meal[`strIngredient${i}`]) {
            recipes += 
            `            <div class="recipes-item alert-success rounded-1 alert alert-info p-1 me-2 mb-2">
    ...
    for (let i = 0; i < tagsStr.length; i++) {
        tags += 
        `            <div class="tag-item alert-success rounded-1 alert alert-danger p-2 me-2 mb-2">
